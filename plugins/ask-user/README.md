...
3. Use the arrows or Tab/Shift-Tab to move between questions. In an interactive Prime Agent client that exposes custom extension UI, the questionnaire stays in one TUI panel; after the last question choose `Submit answers`.
